...
-keep class com.susil.sonora.models.PersistQueue { *; }
-keep class com.susil.sonora.models.PersistPlayerState { *; }
-keep class com.susil.sonora.models.QueueData { *; }
-keep class com.susil.sonora.models.QueueType { *; }
-keep class com.susil.sonora.playback.queues.** { *; }
